...
public class UserController{
    func insertUser(newUser: User){
        ...
        if (userEntity != nil){
            ...
            user.setValue(newUser.phoneNumber, forKey: "contact_number")
            user.setValue(newUser.plateNumber, forKey: "plate_number")
    ...
    func updateUser(user : User){
        ...
        do{
            ...
            existingUser.setValue(user.phoneNumber, forKey: "contact_number")
            existingUser.setValue(user.plateNumber, forKey: "plate_number")
